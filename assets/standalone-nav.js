...
(function () {
  var TABS = [
    { id: "exhibits", href: "exhibits.html", label: "Exhibits" },
    { id: "pidact", href: "pid-act-protections.html", label: "PID Act protections" },
    ...
    { id: "exile", href: "personal-statement-exile.html", label: "Exile" }
  ];
