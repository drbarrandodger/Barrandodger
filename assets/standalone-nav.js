(function () {
  var TABS = [
    ...
    { href: "techniques-h.html", label: "H cluster" },
  ...
  if (!document.getElementById("permanent-status-banner")) {
    ...
    ban.innerHTML =
      ...
      '<p><strong>Current status \u2014 author\u2019s account, not a police or court finding.</strong> He states he is presently trapped in coercive kidnapping, unable to leave; and that he is subject to abuse, neglect, surveillance, imposed poverty, electronic harassment, alleged V2K, and constant libel and slander.</p>' +
      '<p><strong>Alleged goal of that campaign \u2014 author\u2019s interpretation.</strong> To devalue him; destroy his character; block anyone from acknowledging the facts of this testimony and its evidence; by character assassination built on reprehensible allegations that have not been tested by charge, arrest or legal process; extra-judicial societal punishment without a pathway to justice.</p>' +
